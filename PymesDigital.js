function revisarRegistros() {
  ...
  var hoja = ss.getSheetByName("Lead Forms");
  if (!hoja) {
  ...
  if (!huboRegistros) {
    ...
    var asuntoJefes = "Alerta: No hubo registros para " + hoja.getName() + " el " + Utilities.formatDate(ayer, tz, "yyyy-MM-dd");
    ...
    var urlHoja = ss.getUrl();
    var asuntoRebe = "Reporte: Sí hubo registros en Tranquilidad Pymes" + hoja.getName() + " el " + Utilities.formatDate(ayer, tz, "yyyy-MM-dd");
